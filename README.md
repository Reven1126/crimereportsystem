...
• User can register and login and a file a complaint using Personal number
...
• We also added a google map in our user portal page which detects your current location and shows you the location of nearest police station (For Future Use)

...
session_start();
    ...
    $u_id=$_SESSION['u_id'];
        ...
        $result=mysqli_query($conn,"SELECT r_no FROM user where u_id='$u_id' ");
...
if(isset($_POST['s'])){
    ...
    if($var>=0)
    {
      ...
      $comp="INSERT into complaint(a_no,location,type_crime,d_o_c,description) values('$r_no','$location','$type_crime','$d_o_c','$description')";
	...
	<div class="center-container">
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<form action="#" method="post" style="color: gray">Reporter Number
					<input type="text"  name="report_number" placeholder="Report Number" required="" disabled value=<?php echo "$r_no"; ?>>
...
<div style="position: relative;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Iwahig Prison Portal 2021</b></h4>
</div>

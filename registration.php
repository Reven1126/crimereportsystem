...
if(isset($_POST['s'])){
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        $a_no=$_POST['personal_number'];
        $gen=$_POST['gender'];
        $mob=$_POST['mobile_number'];
       // $password=md5($u_pass);
       $reg="insert into user values('$u_name','$u_id','$u_pass','$u_addr','$p_no','$gen','$mob')";
...
<script>
     function f1()
        {
            ...
            var sta4=document.getElementById("perso").value;
  ...
  var x4=sta4.indexOf(' ');
    ...
    document.getElementById("perso").focus();
      alert("Space Not Allowed");
        }
        else if(sta5!="" && x5>=0){
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<p style="color:#dfdfdf">Personal Number</p><input type="text"  name="personal_number" minlength="12" maxlength="12" required pattern="[123456789][0-9]{11}" id="perso" onfocusout="f1()"/>
